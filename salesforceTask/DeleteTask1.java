...
//		7.Click on Dropdown icon available under tasks and select value as Recently viewed
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//a[contains(@class,'rowActionsPlaceHolder slds-button')])[3]")).click();
		...
		String Text = driver.findElement(By.xpath("//div[@class='detail slds-text-align--center']")).getText();
